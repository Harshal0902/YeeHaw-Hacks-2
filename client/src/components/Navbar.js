                    ...
                    <nav className="flex items-center py-2 flex-wrap px-4 text-fontColor tracking-wider">
                                    ...
                                    <div className="relative my-6 mx-auto w-screen">
                                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-secondary outline-none focus:outline-none">
                                            ...
                                            >
                                                ...
                                                <Link to="/play">
                                                    <span className="lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Play Quest</span>
                                                </Link>
                        ...
                        <div className="hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto" >
                            <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full text-xl lg:items-center items-start flex flex-col lg:h-auto space-x-2 mr-12" >
                                ...
                                <Link to="/play">
                                    <span className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Play Quest</span>
                                </Link>

                                <Link to="/leaderboard">
                                    <span className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Leaderboard</span>
                                </Link>

                                <button className='bg-[#663300] text-white py-2 px-8 rounded-md' onClick={handleLogout}>
                                    Logout
                                </button>
